...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6779472292:AAGcZ5AF1p9BNWfvxUjeXtOF231W-JHkEJo")
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://kfcinemas:kfcinemas11@kfcinemas.0as5a.mongodb.net/?retryWrites=true&w=majority&appName=kfcinemas")
DB_NAME = os.environ.get("DATABASE_NAME", "kfcinemas")
...
#start message
START_PIC = os.environ.get("START_PIC","https://envs.sh/fSY.jpg")
